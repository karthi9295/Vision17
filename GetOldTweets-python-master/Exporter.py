...
def main(argv):
 ...
 python Exporter.py --username "barackobama" --maxtweets 10 --toptweets\n"""
	...
	try:
		...
		#outputFile = open("output_got.csv", "w", "utf-8")
		
		#outputFile.write('username;userid;date;retweets;favorites;text;geo;mentions;hashtags;id;permalink')
		#outputFile.write('username;date;retweets;favorites;text;geo;mentions;hashtags;id;permalink')
		outputFile.write("username"+","+"date"+","+"retweets"+","+"favorites"+","+"text"+","+"geo"+","+"mentions"+","+"hashtags"+","+"id"+","+"permalink")
		#outputFile.write("username"+","+"date"+","+"retweets"+","+"favorites"+","+"text"+","+"mentions"+","+"hashtags")
		print 'Searching...\n'
		
		def receiveBuffer(tweets):
			i = 0
			for t in tweets:
				text = t.text.decode('utf-8')
				text = text[:140]
				#i = i+1
				#if(i == 23):
				#	print(text)
				...
				#print(len(text))
				outputFile.write("\n")
				outputFile.write(t.username+","+t.date.strftime("%Y-%m-%d %H:%M")+","+t.retweets+","+t.favorites+","+text+","+t.geo+","+t.mentions+","+t.hashtags+","+t.id+","+t.permalink)
				#print "\n"
				#print (t.username+","+t.date.strftime("%Y-%m-%d %H:%M")+","+t.retweets+","+t.favorites+","+t.text+","+t.geo+","+t.mentions+","+t.hashtags+","+t.id+","+t.permalink)	
			outputFile.flush();
			print 'Saving %d tweets in file...\n' % len(tweets)
